...
def start(update, context):
    ...
    update.message.reply_text('''Hi! I am best link giving bot created by Ryuk. You can download movies,anime,books,games,apps etc...
...
def main():
    ...
    updater = Updater("1455027954:AAGIhY3S0zvhgOCdQI6d0ekLqaUKdArR5Eg", use_context=True)
